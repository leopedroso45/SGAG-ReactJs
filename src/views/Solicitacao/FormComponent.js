...
export default class FormularioSolicitacao extends React.Component {
  ...
  componentWillMount() {
    //  const requestGrupos = axios.get('localhost:8081/acg/grupo');
    //  const requestAtividades = axios.get('localhost:8081/acg/atividade');
  ...
  handleSubmit = event => {
    ...
    axios
      .post(`http://localhost:8081/acg`, { solicitacao })
